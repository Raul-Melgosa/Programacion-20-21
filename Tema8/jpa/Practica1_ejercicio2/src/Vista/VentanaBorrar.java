...
public class VentanaBorrar extends javax.swing.JFrame {
    ...
    private void bAceptarBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarBorrarActionPerformed
        try
        {
            Controlador.eliminarEvento(tfNombre.getText());
            tfNombre.setText("Evento eliminado con éxito");
            tfNombre.setForeground(new java.awt.Color(0, 255, 51));
        }
        catch(Exception e)
        {
            tfNombre.setText("El evento no se ha eliminado");
            tfNombre.setForeground(new java.awt.Color(255, 0, 0));
        }
