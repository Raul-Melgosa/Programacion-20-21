 ...
 * @author 1GDAW09
 */
public class PantallaAltaClientes extends javax.swing.JFrame {

    /**
     * Creates new form PantallaClientes
     */
    public PantallaAltaClientes() {
        initComponents();
    }
    /**
    ...
    private void bAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarActionPerformed
        try
        {
            Controlador.hacerAltaCliente(tfDni.getText(),tfNombre.getText(),tfApellidos.getText(),tfDireccion.getText(),tfTelefono.getText(),tfCorreo.getText());
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaAltaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaAltaClientes().setVisible(true);
            }
        });
    }
