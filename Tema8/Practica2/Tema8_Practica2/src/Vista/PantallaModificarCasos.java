 ...
 * @author 1GDAW09
 */
public class PantallaModificarCasos extends javax.swing.JFrame {

    /**
     * Creates new form PantallaClientes
     */
    public PantallaModificarCasos() {
        initComponents();
        
    }
    
    public ArrayList<javax.swing.JCheckBox> listaCheckbox = new ArrayList();
    /**
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Formulario de asignacion de casos");
    ...
    private void bLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bLimpiarActionPerformed
        ...
        {
            listaCheckbox.get(x).setSelected(false);
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try
        {
            ...
            ArrayList<String> datos = Controlador.hacerConsultaDniAbogados();
            for(int x=0; x<datos.size(); x++)
            {
                javax.swing.JCheckBox a = new javax.swing.JCheckBox();
                a.setText(datos.get(x));
                listaCheckbox.add(a);
                if(x==0)
                {
                    jPanel2.add(a);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaModificarCasos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaModificarCasos().setVisible(true);
            }
        });
    }
