...
public class VentanaModificar extends javax.swing.JFrame {
    ...
    private void cbNombresEventosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbNombresEventosActionPerformed
        try
        {
            ArrayList<String> datos = Controlador.consultarDatosEvento(cbNombresEventos.getSelectedItem().toString());
            tfNombre.setText(datos.get(0));
            tfFecha.setText(datos.get(1));
            tfHoraInicio.setText(datos.get(2));
            tfHoraFin.setText(datos.get(3));
            tfLugar.setText(datos.get(4));
            tfNumeroPersonas.setText(datos.get(5));
        }
        catch(Exception e)
        {
            System.out.println(e.getClass() +"\n" + e.getMessage());
